			...
			<Container isMainPage={true}>
				...
				<div className={styles.Contacts__links}>
					<div className={styles.Contacts__banner}>
						...
						<div>
							...
							<Link href="pages/contacts#"><a>Раздел вопросов</a></Link>
						</div>
					</div>
					<div className={styles.Contacts__partners}>
						...
						<div>
							<Link href="pages/contacts#"><Button.Outlined>Подробнее</Button.Outlined></Link>
						</div>
					</div>
				</div>
				<div className={styles.Contacts__contact}>
					<div className={styles.Contacts__address}>
						...
						<Link href="pages/contacts#"><a type="tel:88000000000">8 (800) 000-00-00</a></Link>
						<h3>Дополнительный телефон</h3>
						<Link href="pages/contacts#"><a type="tel:84950000000">8 (495) 000-00-00</a></Link>
						<h3>Для партнеров</h3>
						<Link href="pages/contacts#"><a type="mailto:partner@uneed-guide.com">partner@uneed-guide.com</a></Link>
						<h3>Помощь клиентам</h3>
						<Link href="pages/contacts#"><a type="mailto:Help@uneed-guide.com">Help@uneed-guide.com</a></Link>
					</div>
