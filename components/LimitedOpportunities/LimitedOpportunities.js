		...
		<div className={styles.LimitedOpportunities}>
			<Container>
				<div className={styles.LimitedOpportunities__title}>
					<div>
						<Title style={{marginBottom: 0}}>С ограниченными возможностями</Title>
						<span>Предоставляем подборку лучших экскурсий, которые будут комфортны для людей с ограниченными возможностями</span>
					</div>
			...
			<Container>
				<footer className={styles.LimitedOpportunities__footer}>
					<Link href="#">
						<a>
							Все экскурсии в данной категории
