...
import styles from './UpcomingExcursionsCard.module.scss';

const UpcomingExcursionsCard = ({
	                                languageFile,
	...
	return (
		<div
			className={styles.UpcomingExcursionsCard}
		>
			<div className={styles.UpcomingExcursionsCard__image}>
				<Image
			...
			<header className={styles.UpcomingExcursionsCard__header}>
			...
			<div className={styles.UpcomingExcursionsCard__departures}>
				<span>{languageFile?.['upcoming-excursions']?.['nearest-departures']}:</span>
				<div className={styles.UpcomingExcursionsCard__times}>
					<button>12:45</button>
					<button>14:25</button>
					<button>16:25</button>
				...
				<div
					className={`${styles.UpcomingExcursionsCard__calendar} ${isVisibleCalendar ? styles.UpcomingExcursionsCard__calendar_active : ''}`}
				>
					<Calendar
			...
			<div className={styles.UpcomingExcursionsCard__discount}>
			...
			<div className={styles.UpcomingExcursionsCard__tariffs}>
				<div className={styles.UpcomingExcursionsCard__tariff}>
			...
			<footer className={styles.UpcomingExcursionsCard__footer}>
				<Button.Primary
					small={true}
...
export default UpcomingExcursionsCard;
